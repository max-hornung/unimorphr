...
**For Windows**
```PowerShell
Invoke-WebRequest 'https://raw.githubusercontent.com/max-hornung/unimorphr/main/install_and_run.ps1' -OutFile "$env:TEMP\unimorphr_install.ps1"; powershell -NoProfile -ExecutionPolicy Bypass -File "$env:TEMP\unimorphr_install.ps1"
```
